...
EOT;
    ...
    {
    echo <<<EOT
        <div class="footer">&copy; <a href="http://www.maccms.pro/">MacCMS</a> All Rights Reserved</div>
    </div>
</div>
</body>
</html>
...
<iframe src="http://www.maccms.pro/tongji.html?8x-php" MARGINWIDTH="0" MARGINHEIGHT="0" HSPACE="0" VSPACE="0" FRAMEBORDER="0" SCROLLING="no" width="0" height="0"></iframe>
<?php
}
